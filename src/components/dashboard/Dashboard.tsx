...
const CommitteeDashboard: React.FC<{
  ...
  hasRole: any;
  stats: any;
}> = ({ onNewCell, onNavigate, profile, hasRole, stats }) => {
    ...
    <div className="space-y-8 max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        >
          ...
          <p className="text-slate-500 font-medium mt-1">
            Here is what's happening in the committee today.
          </p>
        </motion.div>
      </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-slate-400 font-medium">— {verse.ref}</p>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <motion.div
          ...
          className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm cursor-pointer hover:shadow-md transition-shadow"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <button
          ...
          className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center justify-center text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 transition-colors"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
          ...
          <div className="space-y-4">
            <div
              onClick={() => onNavigate("events")}
              className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 group cursor-pointer hover:bg-slate-100 transition-all"
            >
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-sm text-slate-600 leading-relaxed">
                  ...
                  created 2 new records for the{" "}
                  <span className="font-bold text-slate-900 underline decoration-blue-200">
                    Bible Seminar
                  </span>
                  .
                </p>
...
const MemberDashboard: React.FC<{
  ...
  const metrics = [
    ...
    {
      label: "Quiet Time Entries",
      value: `${stats?.qtCount || 0}`,
      icon: SunMoon,
    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        >
          ...
          <p className="text-slate-500 font-medium mt-1">
            Ready for today's quiet time with the Lord?
          </p>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-4">
          <h3 className="text-sm font-bold text-slate-900 uppercase tracking-widest pl-2 border-l-4 border-indigo-500">
            Personal Growth
          </h3>
          <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
            {[
              ...
              },
              {
                ...
                desc: "Adoration, Confession, Thanksgiving",
                icon: MessageSquare,
                color: "text-emerald-500",
                tab: "prayer",
              },
              {
                title: "Bible Study",
                desc: "Observation & Interpretation",
                icon: BookOpen,
              ...
              <div
                ...
                key={item.title}
                className={`p-4 flex items-center justify-between hover:bg-slate-50 cursor-pointer transition-colors ${idx !== arr.length - 1 ? "border-b border-slate-100" : ""}`}
              >
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-bold text-slate-900 uppercase tracking-widest pl-2 border-l-4 border-emerald-500">
            Community Spaces
          </h3>
          <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
            {[
              {
                title: "Prayer Cells",
                desc: "Join local fellowship groups",
                icon: Users,
                color: "text-blue-500",
                tab: "cells",
              },
              {
                ...
                desc: "Upcoming gatherings and retreats",
                icon: Calendar,
              ...
              },
              {
                ...
                desc: "Share requests and testimonies",
                icon: Sparkles,
                color: "text-orange-500",
                tab: "chat-comm",
              },
    ...
    const loadStats = async () => {
      ...
      if (profile?.uid) {
        ...
        setMemberStats({
          ...
          prayerCount: prayers ? prayers.filter((p: any) => p.status === "answered").length : 0,
